...
def pinchoff_dmm(dummy_dmm):
    dummy_dmm.add_parameter('po_current',
    ...
    dummy_dmm.add_parameter('po_sensor',
...
def dot_dmm(dummy_dmm):
    dummy_dmm.add_parameter('dot_current',
                    parameter_class=DotCurrent,
                    label='dot current',
                    unit="A",
                    get_cmd=None, set_cmd=None)

    dummy_dmm.add_parameter('dot_sensor',
...
@pytest.fixture(scope="function")
def device_fivedot_inputs(dummy_dmm, dummy_dac):
    readout_methods = {
